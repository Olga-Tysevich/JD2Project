...
public class LiquidationCauseConverter {
    ...
    public static LiquidationCause convertDTOReqToEntity(LiquidationCauseDTOReq req) {
    ...
    public static List<LiquidationCause> convertDTOReqListToEntityList(List<LiquidationCauseDTOReq> repairCategories) {
        return repairCategories.stream()
                .map(LiquidationCauseConverter::convertDTOReqToEntity)
                .collect(Collectors.toList());
    }
