...
import static it.academy.utils.constants.Constants.MODEL_DESCRIPTION_PATTERN;
...
public class RepairConverter {
    ...
    public RepairDTO convertToDTO(Repair repair) {
        ...
        String deviceDescription = String.format(MODEL_DESCRIPTION_PATTERN, brand.getName(),
