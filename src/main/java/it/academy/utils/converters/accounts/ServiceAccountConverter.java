...
public class ServiceAccountConverter {
    ...
    public static List<AccountDTO> convertListToDTO(List<RepairWorkshopAccount> accounts) {
        return accounts.stream()
                .map(ServiceAccountConverter::convertToDTO)
