...
import it.academy.dao.repair.impl.LiquidationCauseDAOImpl;
import it.academy.dao.repair.impl.LiquidationCertificateDAOImpl;
...
import it.academy.services.LiquidationCertificateService;
import it.academy.utils.ExceptionManager;
import it.academy.utils.MessageManager;
import it.academy.converters.repair.LiquidationCauseConverter;
import it.academy.converters.repair.LiquidationCertificateConverter;
...
public class LiquidationCertificateServiceImpl implements LiquidationCertificateService {
    ...
    public RespDTO<LiquidationCauseDTOReq> addLiquidationCause(LiquidationCauseDTOReq req) {
        LiquidationCause cause = ExceptionManager.tryExecute(() -> LiquidationCauseConverter.convertToEntity(req));
    ...
    public RespDTO<LiquidationCertificateDTOReq> addLiquidationCertificate(LiquidationCertificateDTOReq req) {
        LiquidationCertificate certificate = ExceptionManager.tryExecute(() -> LiquidationCertificateConverter.convertToEntity(req));
